...
function About() {
  return (
    <>
      <div className="container-fluid banner1-1 ">
        <div className="container">
          <div className="row">
            <div className="col-md-3"></div>
            <div className="col-md-6">
              <h1 className="text-white text-center text-2 display-3">
                OUR STORY
              </h1>
            </div>
            <div className="col-md-3"></div>
      ...
      <div className="container  mt-4">
        <h1 className="text-center">
          ONCE UPON<b className="h-cl1"> AN AFFAIRE</b>
        </h1>
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-5 text-center">
            <img
              src="https://www.firstfiddle.in/assets/images/ffbanner1.jpg"
              className="webimg shadowimg"
              alt="img"
            />
          </div>
        </div>
      ...
      <div className="container-fluid BANNER3 mt-5">
        <div className="container">
          <div className="row">
            <div className="col-md-2"></div>
            <div className="col-md-8">
              <h1 className="text-white text-center mt-5 h-cl4">
                THE GAME CHANGER
              </h1>
              <p className="p text-white a-cl3">
      ...
      <div className="container mt-5">
        <h1 className="text-center acl1">
          THE MAN BEHIND<b className="h-cl1"> THE FIDDLE</b>
        </h1>

        <div className="row mt-4">
          <div className="col-md-5 text-center">
            <img
              src="https://www.firstfiddle.in/assets/images/about/about-priyank.jpg"
              className="webimg shadowimg"
              alt=""
            />
          </div>
      ...
      <div className="container mt-5">
        <h1 className="text-center ">
          JOIN<b className="h-cl1"> OUR FAMILY</b>
        </h1>
        ...
        <div className="row">
          <div className="col-md-7 mt-4">
            <p className="p">
              ...
              recognition.
              <button className="btn  mt-5 ml-4 a-cl2">
                FRANCHISE WITH US
              </button>
            </p>
          </div>
          <div className="col-md-5 text-center mt-4">
            <img
              src="https://www.firstfiddle.in/assets/images/about/333X3322.jpg"
              className="webimg shadowimg"
              alt="img"
            />
          </div>
